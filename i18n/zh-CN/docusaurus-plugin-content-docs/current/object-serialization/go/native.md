...
如果字节需要由 Java、Python、C++、Rust、JavaScript/TypeScript、C#、Swift、Dart、Scala、Kotlin 或其他非 Go Fory 实现读取，请使用 Go 默认模式[跨语言序列化](core-api.md#cross-language-interoperability)。
...
- [跨语言序列化](core-api.md#cross-language-interoperability) - 跨语言 Go 载荷
