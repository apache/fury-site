...
如果字节需要由非 Java Fory 实现读取，请使用 Java 默认的[跨语言序列化](basic-serialization.md#cross-language-interoperability)模式。
...
- [基础序列化](basic-serialization.md) - 跨语言优先的 Java 快速入门
- [跨语言序列化](basic-serialization.md#cross-language-interoperability) - 跨语言 Java 载荷
