...
该基准使用相同的数据比较 fory-json、Jackson 和 Gson。String 组不包含 UTF-8 转换。UTF-8
字节组会在可用时直接使用字节数组 API。Gson 的结果包含从 String 到 UTF-8 的编码，以及从
UTF-8 到 String 的解码。
...
![Java JSON String 基准吞吐量](string_throughput.png)

## UTF-8 字节

![Java JSON UTF-8 字节基准吞吐量](utf8_bytes_throughput.png)
