...
Person out = (Person) fory.deserialize(bytes);`,
  },
  {
    ...
    install: `pip install pyfory==1.7.1`,
    codeLanguage: "python",
...
fn main() -> Result<(), Error> {
  ...
  },
  {
    ...
    label: "Go",
    installLanguage: "bash",
    install: `go get github.com/apache/fory/go/fory@v1.7.1`,
    codeLanguage: "go",
...
auto out = fory.deserialize<Person>(bytes).value();`,
  },
  {
    ...
    label: "JavaScript",
    installLanguage: "bash",
    install: `npm install @apache-fory/core@1.7.1 @apache-fory/hps@1.7.1`,
...
const out = deserialize(payload);`,
  },
  {
    ...
    label: "C#",
    installLanguage: "bash",
    install: `dotnet add package Apache.Fory --version 1.7.1`,
    codeLanguage: "csharp",
...
Person out = fory.Deserialize<Person>(payload);`,
  },
  {
    ...
    install: `.package(url: "https://github.com/apache/fory.git", exact: "1.7.1")`,
    codeLanguage: "swift",
...
final out = fory.deserialize<Person>(payload);`,
  },
  {
    ...
    label: "Scala",
    installLanguage: "sbt",
    install: `libraryDependencies += "org.apache.fory" %% "fory-scala" % "1.7.1"`,
    codeLanguage: "scala",
...
val out = fory.deserialize(payload).asInstanceOf[Person]`,
  },
  {
    ...
    install: `implementation("org.apache.fory:fory-kotlin:1.7.1")
ksp("org.apache.fory:fory-kotlin-ksp:1.7.1")`,
    codeLanguage: "kotlin",
