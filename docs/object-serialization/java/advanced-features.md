...
Java native-mode zero-copy serialization is documented in [Native Serialization](native.md), and deep
...
- [Xlang Serialization](xlang.md) - Java xlang interoperability
