...
Use this page when a Scala reader accepts bytes from outside the application's trust boundary.
...
See [Configuration](configuration.md) for the Scala option reference and
