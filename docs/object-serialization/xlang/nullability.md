...
For detailed reference tracking behavior, see [Reference Tracking](references.md).
...
- [Reference Tracking](references.md) - Shared and circular reference handling
- [Xlang Overview](index.md) - Cross-language serialization workflow and runtime guides
