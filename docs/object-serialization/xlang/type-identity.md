---
title: Type Identity and Dynamic Fields
sidebar_position: 2
id: type-identity
license: |
...
- [Field Nullability](nullability.md) - Controlling null handling for fields
- [Reference Tracking](references.md) - Managing shared/circular references
- [Type Mapping](../../specification/xlang_type_mapping.md) - Cross-language type compatibility

## Coordinate Type Identity Across Peers

Every peer must register a custom type with the same numeric ID or the same
namespace and type name. Numeric IDs produce smaller metadata; names are
easier to coordinate across independently deployed services. Do not mix an
