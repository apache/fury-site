...
Use [Cross-Language Interoperability](core-api.md#cross-language-interoperability), the default Go mode, when bytes must be read by
...
- [Cross-Language Interoperability](core-api.md#cross-language-interoperability) - Cross-language Go payloads
