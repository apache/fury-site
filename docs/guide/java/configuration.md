...
| `maxUnbackedContainerItems`         | Maximum collection elements and map entries whose repeated read bodies are not backed by input progress during one root deserialization. Zero is strict.                                                                                                                                                                                                                                                                                                                                                                                      | `8192`                                                               |
