...
out = fory.deserialize(data)`},{id:"rust",label:"Rust",installLanguage:"bash",install:"cargo add fory@1.5.0",codeLanguage:"rust",guide:"/docs/guide/rust/",summary:"Rust uses derive macros for type-safe structs and supports both xlang and native payloads.",code:`use fory::{Error, Fory, ForyStruct};
...
FetchContent_MakeAvailable(fory)`,codeLanguage:"cpp",guide:"/docs/guide/cpp/",summary:"C++17 support covers xlang/native payloads, macro-based type registration, and row-format APIs.",code:`struct Person {
  std::string name;
  int32_t age;
...
auto out = fory.deserialize<Person>(bytes).value();`},{id:"javascript",label:"JavaScript",installLanguage:"bash",install:"npm install @apache-fory/core @apache-fory/hps",codeLanguage:"typescript",guide:"/docs/guide/javascript/",summary:"JavaScript/TypeScript is xlang-only, schema-driven, and runs in Node.js or browsers.",code:`import Fory, { Type } from "@apache-fory/core";
...
const out = deserialize(payload);`},{id:"csharp",label:"C#",installLanguage:"bash",install:"dotnet add package Apache.Fory --version 1.5.0",codeLanguage:"csharp",guide:"/docs/guide/csharp/",summary:".NET support uses source-generated serializers for Fory structs, enums, and unions.",code:`using Apache.Fory;
...
Person out = fory.Deserialize<Person>(payload);`},{id:"swift",label:"Swift",installLanguage:"swift",install:'.package(url: "https://github.com/apache/fory.git", exact: "1.5.0")',codeLanguage:"swift",guide:"/docs/guide/swift/",summary:"Swift uses @ForyStruct, @ForyEnum, and @ForyUnion macros for xlang-compatible models.",code:`import Fory
...
final out = fory.deserialize<Person>(payload);`},{id:"scala",label:"Scala",installLanguage:"sbt",install:'libraryDependencies += "org.apache.fory" %% "fory-scala" % "1.5.0"',codeLanguage:"scala",guide:"/docs/guide/scala/",summary:"Scala builds on Fory Java with optimized serializers for case classes, collections, tuples, and Option.",code:`import org.apache.fory.scala.ForyScala
...
val out = fory.deserialize(payload).asInstanceOf[Person]`},{id:"kotlin",label:"Kotlin",installLanguage:"kotlin",install:`implementation("org.apache.fory:fory-kotlin:1.5.0")
ksp("org.apache.fory:fory-kotlin-ksp:1.5.0")`,codeLanguage:"kotlin",guide:"/docs/guide/kotlin/",summary:"Kotlin adds data-class support, Android guidance, and KSP static serializers for xlang/schema mode.",code:`import org.apache.fory.kotlin.ForyKotlin
...
${x.flatMap(e=>e.code?[e.code]:[]).join("\n\n")}`,j=[{label:"IDL Overview",zhLabel:"IDL \u6982\u89C8",link:"/docs/compiler/"},{label:"Compiler Guide",zhLabel:"\u7F16\u8BD1\u5668\u6307\u5357",link:"/docs/compiler/compiler_guide"},{label:"Generated Code",zhLabel:"\u751F\u6210\u4EE3\u7801",link:"/docs/compiler/generated_code"}],v=[{value:"Optimized Serializers",zhValue:"\u4F18\u5316 Serializer",text:"Use JIT serializers, source generators, macros, KSP, and build_runner where each runtime supports them.",zhText:"\u5728\u5404\u8FD0\u884C\u65F6\u4F7F\u7528 JIT serializer\u3001source generator\u3001macro\u3001KSP \u548C build_runner\u3002"},{value:"Efficient Encoding",zhValue:"\u9AD8\u6548\u7F16\u7801",text:"Encode typed objects into an efficient binary format for fast serialization and deserialization.",zhText:"\u5C06\u7C7B\u578B\u5316\u5BF9\u8C61\u7F16\u7801\u4E3A\u9762\u5411\u5FEB\u901F\u5E8F\u5217\u5316\u548C\u53CD\u5E8F\u5217\u5316\u7684\u9AD8\u6548\u4E8C\u8FDB\u5236\u683C\u5F0F\u3002"}],T=[{title:"Language boundary",zhTitle:"\u8BED\u8A00\u8FB9\u754C",text:"Use xlang when services in different languages need to exchange the same typed payload directly.",zhText:"\u5F53\u4E0D\u540C\u8BED\u8A00\u670D\u52A1\u9700\u8981\u76F4\u63A5\u4EA4\u6362\u540C\u4E00\u4EFD\u7C7B\u578B\u5316\u8F7D\u8377\u65F6\uFF0C\u4F7F\u7528 xlang\u3002"},{title:"Runtime boundary",zhTitle:"\u8FD0\u884C\u65F6\u8FB9\u754C",text:"Use native mode when objects stay inside one runtime and object graph fidelity matters.",zhText:"\u5F53\u5BF9\u8C61\u53EA\u5728\u540C\u4E00\u8FD0\u884C\u65F6\u5185\u6D41\u8F6C\uFF0C\u4E14\u5BF9\u8C61\u56FE\u8BED\u4E49\u91CD\u8981\u65F6\uFF0C\u4F7F\u7528 native mode\u3002"},{title:"Read boundary",zhTitle:"\u8BFB\u53D6\u8FB9\u754C",text:"Use row format for partial reads and analytics workloads that should not rebuild whole objects.",zhText:"\u5F53\u90E8\u5206\u8BFB\u53D6\u548C\u5206\u6790\u7C7B\u5DE5\u4F5C\u8D1F\u8F7D\u4E0D\u5E94\u91CD\u5EFA\u5B8C\u6574\u5BF9\u8C61\u65F6\uFF0C\u4F7F\u7528 row format\u3002"}],S=[{label:"01",title:"Choose the wire mode",zhTitle:"\u9009\u62E9 wire mode",text:"Use xlang for portable payloads shared across languages; use native mode for same-runtime traffic that needs broader runtime-specific object models.",zhText:"\u8DE8\u8BED\u8A00\u5171\u4EAB payload \u65F6\u4F7F\u7528 xlang\uFF1B\u540C\u8FD0\u884C\u65F6\u6D41\u91CF\u9700\u8981\u66F4\u5B8C\u6574\u7684\u8BED\u8A00\u5BF9\u8C61\u6A21\u578B\u65F6\u4F7F\u7528 native mode\u3002",cta:"Usage guide",zhCta:"\u4F7F\u7528\u6307\u5357",action:"Usage guide",zhAction:"\u4F7F\u7528\u6307\u5357",link:"/docs/start/usage"},{label:"02",title:"Promote shared contracts",zhTitle:"\u6C89\u6DC0\u5171\u4EAB\u5951\u7EA6",text:"Define Fory IDL once, generate type-safe native models across languages, and use optional fields, refs, unions, or services when contracts evolve.",zhText:"\u7528 Fory IDL \u5B9A\u4E49\u4E00\u6B21\u6A21\u578B\uFF0C\u751F\u6210\u591A\u8BED\u8A00\u7C7B\u578B\u5B89\u5168\u4EE3\u7801\uFF1B\u5951\u7EA6\u6F14\u8FDB\u65F6\u4F7F\u7528 optional\u3001ref\u3001union \u6216 service\u3002",cta:"Schema IDL guide",zhCta:"Schema IDL",action:"Schema IDL guide",zhAction:"Schema IDL \u6307\u5357",link:"/docs/compiler/"},{label:"03",title:"Benchmark the rollout path",zhTitle:"\u9A8C\u8BC1\u4E0A\u7EBF\u8DEF\u5F84",text:"Compare serialization throughput, deserialization throughput, payload size, and reproduction steps for the runtime you plan to ship.",zhText:"\u6309\u8BA1\u5212\u4E0A\u7EBF\u7684\u8FD0\u884C\u65F6\u5BF9\u6BD4\u5E8F\u5217\u5316/\u53CD\u5E8F\u5217\u5316\u541E\u5410\u3001payload \u5927\u5C0F\u548C\u590D\u73B0\u5B9E\u9A8C\u6B65\u9AA4\u3002",cta:"Benchmark charts",zhCta:"Benchmark",action:"Benchmark charts",zhAction:"Benchmark \u56FE\u8868",link:"/docs/introduction/benchmark"}];function w(e){return"zh-CN"===e?"zh":"en"}let P=function(){let{i18n:{currentLocale:e}}=(0,o.A)(),a=y[w(e)],s="zh"===w(e),[r,l]=(0,i.useState)("java"),p=(0,i.useMemo)(()=>g.find(e=>e.id===r)??g[0],[r]);return(0,t.jsxs)("main",{className:"homepage_Mn1j",children:[(0,t.jsxs)("section",{className:"hero_H13s",children:[(0,t.jsxs)("div",{className:"heroContent_hqVf",children:[(0,t.jsx)("h1",{children:a.heroTitle}),(0,t.jsx)("p",{className:"heroSubtitle_PdJw",children:a.heroSubtitle}),(0,t.jsxs)("div",{className:"heroActions_Bt4v",children:[(0,t.jsx)(n.A,{className:"primaryButton_PGGg",to:"/docs/start/install",children:a.heroPrimary}),(0,t.jsx)(n.A,{className:u,to:"/docs/introduction/overview",children:a.heroSecondary}),(0,t.jsx)(n.A,{className:"ghostButton_VNyw",to:"https://github.com/apache/fory",children:a.heroGithub})]})]}),(0,t.jsx)("div",{className:"surfacePanel_P5f3","aria-label":s?"Fory \u6587\u6863\u5165\u53E3":"Fory documentation paths",children:(0,t.jsx)("div",{className:"surfaceOptions_dRnf",children:b.map(e=>(0,t.jsxs)(n.A,{className:"surfaceOption_iXZZ",to:e.link,children:[(0,t.jsx)("span",{className:"surfaceOptionBadge_WiBk",children:s?e.zhLabel:e.label}),(0,t.jsxs)("span",{className:"surfaceOptionBody_F9sE",children:[(0,t.jsx)("strong",{children:s?e.zhTitle:e.title}),(0,t.jsx)("small",{children:s?e.zhText:e.text})]})]},e.title))})})]}),(0,t.jsxs)("section",{className:"capabilities_38pY",children:[(0,t.jsxs)("div",{className:h,children:[(0,t.jsx)("span",{children:a.capabilitiesEyebrow}),(0,t.jsx)("h2",{children:a.capabilitiesTitle}),(0,t.jsx)("p",{children:a.capabilitiesSubtitle})]}),(0,t.jsx)("div",{className:"capabilityGrid_wiYQ",children:f.map(e=>(0,t.jsxs)(n.A,{className:"capabilityCard_VnNv",to:e.link,children:[(0,t.jsx)("span",{children:e.label}),(0,t.jsx)("h3",{children:s?e.zhTitle:e.title}),(0,t.jsx)("p",{children:s?e.zhDescription:e.description})]},e.title))})]}),(0,t.jsxs)("section",{className:"quickStart_RMXJ",children:[(0,t.jsxs)("div",{className:h,children:[(0,t.jsx)("span",{children:a.quickEyebrow}),(0,t.jsx)("h2",{children:a.quickTitle}),(0,t.jsx)("p",{children:a.quickSubtitle})]}),(0,t.jsxs)("div",{className:"runtimeShell_WQrd",children:[(0,t.jsx)("div",{className:"runtimeTabs_SgP1",role:"tablist","aria-label":"Runtime examples",children:g.map(e=>(0,t.jsx)("button",{"aria-selected":e.id===r,className:e.id===r?"runtimeTabActive_b5i4":"runtimeTab_YjtG",onClick:()=>l(e.id),role:"tab",type:"button",children:e.label},e.id))}),(0,t.jsxs)("div",{className:"runtimeDetail_cEWr",children:[(0,t.jsxs)("div",{className:"runtimeSummary_OyHv",children:[(0,t.jsxs)("div",{className:"runtimeTitleRow_jY3R",children:[(0,t.jsx)("span",{children:p.label}),(0,t.jsx)(n.A,{className:"runtimeGuideButton_xIWL",to:p.guide,children:s?`${p.label} \u{6307}\u{5357}`:`${p.label} Guide`})]}),(0,t.jsx)("p",{children:p.summary}),(0,t.jsxs)("div",{className:"installBlock_LCAE",children:[(0,t.jsx)("div",{className:m,children:a.installLabel}),(0,t.jsx)(c.A,{language:p.installLanguage,children:p.install})]})]}),(0,t.jsxs)("div",{className:"codeBlock_VFPE",children:[(0,t.jsx)("div",{className:m,children:a.codeLabel}),(0,t.jsx)(c.A,{language:p.codeLanguage,children:p.code})]})]})]})]}),(0,t.jsx)("section",{className:"schemaIdl_cE3h",children:(0,t.jsxs)("div",{className:"schemaLayout_XpK6",children:[(0,t.jsxs)("div",{className:"schemaCopy_y6DP",children:[(0,t.jsx)("span",{className:d,children:a.schemaEyebrow}),(0,t.jsx)("h2",{children:a.schemaTitle}),(0,t.jsx)("p",{children:a.schemaSubtitle}),(0,t.jsx)("div",{className:"schemaFeatureList_sBmg",children:x.map((e,a)=>(0,t.jsxs)("article",{className:"schemaFeature_TzQ3",children:[(0,t.jsx)("span",{children:String(a+1).padStart(2,"0")}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{children:s?e.zhTitle:e.title}),(0,t.jsx)("p",{children:s?e.zhText:e.text})]})]},e.title))}),(0,t.jsx)("div",{className:"schemaActions_haf3",children:j.map(e=>(0,t.jsx)(n.A,{className:"schemaActionButton_Egd9",to:e.link,children:s?e.zhLabel:e.label},e.link))})]}),(0,t.jsxs)("div",{className:"schemaPreview_PIA0","aria-label":a.schemaTitle,children:[(0,t.jsxs)("div",{className:"schemaPreviewHeader_E7tH",children:[(0,t.jsx)("span",{children:"model.fdl"}),(0,t.jsx)("strong",{children:"Fory IDL"})]}),(0,t.jsx)(c.A,{language:"protobuf",children:z})]})]})}),(0,t.jsxs)("section",{className:"performance_DK6w",children:[(0,t.jsxs)("div",{className:"performanceCopy_RRfj",children:[(0,t.jsx)("span",{children:a.performanceEyebrow}),(0,t.jsx)("h2",{children:a.performanceTitle}),(0,t.jsx)("p",{children:a.performanceSubtitle}),(0,t.jsx)(n.A,{className:u,to:"/docs/introduction/benchmark",children:a.benchmarkCta})]}),(0,t.jsx)("div",{className:"performanceCards_emZ1",children:v.map(e=>(0,t.jsxs)("div",{className:"performanceCard_cEv3",children:[(0,t.jsx)("strong",{children:s?e.zhValue:e.value}),(0,t.jsx)("p",{children:s?e.zhText:e.text})]},e.value))})]}),(0,t.jsxs)("section",{className:"useCases_wQBm",children:[(0,t.jsxs)("div",{className:h,children:[(0,t.jsx)("span",{children:a.useCasesEyebrow}),(0,t.jsx)("h2",{children:a.useCasesTitle}),(0,t.jsx)("p",{children:a.useCasesSubtitle})]}),(0,t.jsx)("div",{className:"useCaseGrid_yVvJ",children:T.map(e=>(0,t.jsxs)("article",{className:"useCaseCard_fqdc",children:[(0,t.jsx)("h3",{children:s?e.zhTitle:e.title}),(0,t.jsx)("p",{children:s?e.zhText:e.text})]},e.title))})]}),(0,t.jsxs)("section",{className:"ecosystem_EAwp",children:[(0,t.jsxs)("div",{className:"ecosystemHeader_EYS5",children:[(0,t.jsx)("span",{className:d,children:s?"\u91C7\u7528\u8DEF\u5F84":"Adoption path"}),(0,t.jsx)("h2",{children:a.ecosystemTitle}),(0,t.jsx)("p",{children:a.ecosystemSubtitle})]}),(0,t.jsx)("div",{className:"adoptionGrid_xF1l",children:S.map(e=>(0,t.jsxs)("article",{className:"adoptionCard_BhbD",children:[(0,t.jsxs)("div",{className:"adoptionHeaderRow_x0KT",children:[(0,t.jsx)("span",{className:"adoptionStep_R11K",children:e.label}),(0,t.jsx)("h3",{children:s?e.zhTitle:e.title})]}),(0,t.jsx)("p",{children:s?e.zhText:e.text}),(0,t.jsx)(n.A,{className:"adoptionButton_ByAZ",to:e.link,children:s?e.zhAction:e.action})]},e.title))})]})]})};function k(){let{siteConfig:e}=(0,o.A)(),a=(0,l.T)({id:"homepage.metaDescription",message:e.tagline,description:"The meta description of the homepage"});return(0,t.jsx)(r.A,{title:`${e.title}`,description:a,children:(0,t.jsx)(P,{})})}}}]);